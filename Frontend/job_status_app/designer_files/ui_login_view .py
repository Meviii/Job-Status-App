...
class Ui_login_dialog(object):
    def setupUi(self, login_dialog):
        ...
        self.title_label.setGeometry(QRect(30, 40, 291, 81))
        font = QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.verticalLayoutWidget.setGeometry(QRect(110, 110, 131, 78))
        ...
        self.login_button.setGeometry(QRect(180, 192, 61, 25))
        self.response_label = QLabel(login_dialog)
        self.response_label.setObjectName(u"response_label")
        self.response_label.setGeometry(QRect(110, 195, 71, 16))
        QWidget.setTabOrder(self.username_field, self.password_field)
        QWidget.setTabOrder(self.password_field, self.login_button)
